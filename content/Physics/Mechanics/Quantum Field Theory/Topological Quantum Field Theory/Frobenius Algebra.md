...
> [!remark]
> The Frobenius form/pairing is part of the structure. i.e., an algebra can carry various Frobenius structures. A concrete example is illustrated [[Frobenius Algebra#^46636d|later]].
...
- Consider the group algebra $\K G$ over some finite group $G$. The Frobenius form can be defined as follows:
- 
