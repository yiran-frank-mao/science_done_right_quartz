...
> The *bosonic Fock space* over a separable Hilbert space $\H$ is the [[Hilbert Spaces#^ae0212|Hilbert space]] completion defined as the direct sum of the symmetric powers of $\H$: $$\newcommand{\F}{\mathcal{F}}\F_{+}(\H):=\overline{\bigoplus_{i=0}^{\infty}S^{i} \H},$$
