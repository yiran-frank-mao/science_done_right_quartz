...
> Suppose $X$ and $Y$ are [[Topological Spaces#^concept-39ce12df888c|topological spaces]]. If $f \colon X \to Y$ is a [[Relations and Functions#^042daf|bijection]] and both $f$ and $f^{-1}$ are continuous we say that $f$ is a *homeomorphism* and that $X$ and $Y$ are *homeomorphic*. ^85034b
>
