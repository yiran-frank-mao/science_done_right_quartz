...
>[!proposition]
> Let $(X,d)$ be a [[Metric Spaces#^0eacc7|metric space]] and let $(x_{n})$ be a [[Complete Metric Space#^179eeb|Cauchy sequence]] in $X$. If $(x_{n})$ has a convergent subsequence, then $(x_{n})$ is convergent. ^80b2f4
