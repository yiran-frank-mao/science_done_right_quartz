...
> 
> ![universal_quantum_invariant.svg|80%](https://raw.githubusercontent.com/yiran-frank-mao/image_repo/master/Obsidian/universal_quantum_invariant.svg)
...
> [!proposition]
> The algebra of knots, $\C \mathcal{K}$ is formal.

*Proof*  Consider the the space of chord diagrams modulo the 1T and 4T relations, $\mathcal{C}$. Let $\pi\colon \mathcal{C}\twoheadrightarrow \gr \C \mathcal{K}$ be the canonical projection. Let $z\colon\C\mathcal{K}\to \mathcal{C}$ be the Kontsevich integral. Then 
