...
> Let $D$ be a [[Holomorphic and Conformal Maps#^08ef59|domain]], and let $f,g\in H(D)$. Suppose there exists a sequence $z_{1},z_{2}\dots \in D$ of distinct points that converges to a limit $a\in D$ such that $f(z_{i})=g(z_{i})$ for all $i$. Then $f=g$. ^b5768d
