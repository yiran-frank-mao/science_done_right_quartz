...
> [!proposition]
> If $S$ and $T$ are subsets of a finite group $G$, and $|G|<|S|+|T|$, then $G$ is generated by $S$ or $T$.
> 

*Proof*  Denote the subgroup generated by $S$ as $\langle S\rangle$ and the subgroup generated by $T$ as $\langle T\rangle$. Then $|\langle S\rangle| \leq |S|$ and $|\langle T\rangle| \leq |T|$. By [Lagrange’s Theorem](Cosets%20and%20Lagrange’s%20Theorem.md#^add232), we have $|\langle S\rangle| \mid |G|$ and $|\langle T\rangle| \mid |G|$. If neither $\langle S\rangle$ nor $\langle T\rangle$ is equal to $G$, then $|\langle S\rangle| \leq |G|/2$ and $|\langle T\rangle| \leq |G|/2$, which implies that $|S|+|T|\leq |\langle S\rangle|+|\langle T\rangle|\leq |G|$, contradicting the assumption. Therefore, either $\langle S\rangle = G$ or $\langle T\rangle = G$. $\square$
