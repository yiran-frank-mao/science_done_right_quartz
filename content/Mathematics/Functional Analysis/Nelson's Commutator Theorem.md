...
Throughout this note, we will assume that $H$ is a self-adjoint positive operator on $\H$. The following properties are immediate from the definition:
...
> We say that $A$ is *formally Hermitian* if $A = A^\dagger$.
