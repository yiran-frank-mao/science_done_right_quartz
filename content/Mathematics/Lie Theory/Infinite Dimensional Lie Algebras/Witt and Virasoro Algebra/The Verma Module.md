...
> In other words, the Verma module is the [[Objects and Elements#^a7dd74|initial object]] in the [[Structure of Categories#^2f5c3a|category]] $\newcommand{\HW}{\mathbf{HW}_{h,c}^{\bullet}}\HW$ of pointed highest weight representations (i.e., objects are tuples $(V,v_{0})$ where $v_{0}\in V$ is a highest weight vector) of weight $(h,c)$.
> 
