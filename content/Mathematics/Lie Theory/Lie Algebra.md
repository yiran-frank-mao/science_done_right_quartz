...
- Every [[Non-Commutative Rings#^2c3d07|associative algebra]] $A$ over a field $F$ is a Lie algebra with the Lie bracket defined as the commutator: $$[a,b] = ab - ba.$$This is called the *commutator Lie algebra* associated to $A$.
...
$\quad$ 
> [!proposition]
> Lie algebra is a [[Non-Commutative Rings#^2c3d07|non-associative algebra]] over the field.
