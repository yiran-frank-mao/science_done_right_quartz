...
<u><b>e.g.</b></u> 
- The [[Number Systems#^5fea5c|real numbers]] $\R$ and continuous functions $\R \to \R$ is a category of a single object. More generally, [[Topological Spaces#^65c94a|topological spaces]] and [[Continuous Maps on Topological Spaces#^33ee5a|continuous mappings]] form a category $\mathsf{Top}$. ^54ad73
