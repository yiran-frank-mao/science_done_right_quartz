...
> - $\one\in\obj \mathsf{C}$ is called the *monoidal unit*;
...
- The category of [[Groups, Order and Subgroups#^6d511a|abelian groups]] $(\mathsf{Ab},\otimes,\mathbb{Z})$ is a monoidal category with the usual tensor product of abelian groups and the group of integers $\mathbb{Z}$ as the monoidal unit. [[Ring, Field and Integral Domain#^concept-b822d04b4a4b|Rings]] are monoid objects.
...
- The category of [[Vector Spaces#^f4b63e|vector spaces]] over a [[Ring, Field and Integral Domain#^575174|field]] $\newcommand{\K}{\mathbb{K}}\K$ $(\mathsf{Vect}_{\K}, \otimes_{\K}, \K)$ is a monoidal category with the usual [[Tensors and Tensor Products#^732917|tensor product of vector spaces]] and the field $\K$ as the monoidal unit. [[Noncommutative Rings#^2c3d07|Algebras]] are monoid objects; coalgebras are comonoid objects.
- The category of categories $\mathsf{Cat}$ with the [[Constructions on Categories#^8f900b|Cartesian product of categories]] as the monoidal product and the singleton category $\mathbf{1}$ as the monoidal unit is a monoidal category. Monoid objects in $\mathsf{Cat}$ are precisely strict monoidal categories. (The structure on a monoid object forces it to be strict)
$\quad$
