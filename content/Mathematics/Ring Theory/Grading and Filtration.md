...
> - each $A_{n}$ is a sub vector space of $A$,
...
> Hence we have a [[Structure of Categories#^2f5c3a|category]] of graded algebras $\mathbf{GrAlg}$. ^9b78c3
...
> Hence we have a [[Structure of Categories#^2f5c3a|category]] of filtered algebras $\mathbf{FiltAlg}$.
...
> <img src="https://raw.githubusercontent.com/yiran-frank-mao/image_repo/master/Obsidian/associated_graded_algebra.svg" alt="" style="width:65%;">

> [!proposition]
> $\gr$ forms a [[Functoriality and Naturality#^653948|functor]] from $\mathbf{FiltAlg}$ to $\mathbf{GrAlg}$.
