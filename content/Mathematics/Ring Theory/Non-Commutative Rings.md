...
> Given a group $G$ and a field $F$, the group algebra $FG$ of $G$ over $F$, as a vector space, is given by formal linear combinations of elements of $G$: that is, the vector space with basis $G$. The algebra multiplication given by the bilinear extension of multiplication in $G$. ^a15722
